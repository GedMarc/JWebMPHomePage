...
public class WebServicesDisplayScreen
		extends DisplayScreen<WebServicesDisplayScreen>
{
	...
	public @NotNull BSContainer<?> getContentContainer()
	{
		...
		container.add(new PluginModulePart("Guiced Web Services"));
		container.add(buildScreen());
		container.add(buildGoToSource(WebServicesDisplayPart.class));
		return container;
	}
	...
	private Div buildScreen()
	{
		...
		persistence.add(new WebServicesDisplayPart());
		return persistence;
	}
