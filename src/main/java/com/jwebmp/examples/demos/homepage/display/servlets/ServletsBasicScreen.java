		...
		extends DisplayPart<ServletsBasicScreen>
{
	...
	private Div buildAbout()
	{
		...
		addSourceToContainer(ServletsBasicScreen.class, "entityassist_1.txt", SourceCodeLanguages.Java, collapse);
		...
		addSourceToContainer(ServletsBasicScreen.class, "entityassist_4.txt", SourceCodeLanguages.Java, collapse);
	...
	private Div buildJoins()
	{
		...
		addSourceToContainer(ServletsBasicScreen.class, "entityassist_5.txt", SourceCodeLanguages.Java, all);
	...
	private Div buildSpi()
	{
		...
		addSourceToContainer(ServletsBasicScreen.class, "gettingstarted.txt", SourceCodeLanguages.Java, all);
