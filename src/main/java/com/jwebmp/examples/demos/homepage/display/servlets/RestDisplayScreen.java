...
public class RestDisplayScreen
		extends DisplayScreen<RestDisplayScreen>
{
	...
	public @NotNull BSContainer<?> getContentContainer()
	{
		...
		container.add(new PluginModulePart("Guiced Rest Services"));
		container.add(buildScreen());
		container.add(buildGoToSource(RestDisplayPart.class));
		return container;
	}
	...
	private Div buildScreen()
	{
		...
		persistence.add(new RestDisplayPart());
		return persistence;
	}
