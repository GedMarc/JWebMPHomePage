...
public class WebServicesDisplayPart
		extends DisplayPart<WebServicesDisplayPart>
{
	public WebServicesDisplayPart()
	{
		this(false);
	}

	public WebServicesDisplayPart(boolean scrolly)
	{
		...
		addSourceToContainer(WebServicesDisplayPart.class, "rest_services.txt", Java, dualExecution);
		...
		addSourceToContainer(WebServicesDisplayPart.class, "rest_test_case.txt", Java, dualExecution);
