...
import com.jwebmp.examples.demos.homepage.display.quickstart.JSFDisplayPart;
...
public class JSFDisplayScreen
		extends DisplayScreen<JSFDisplayScreen>
{
	...
	public @NotNull BSContainer<?> getContentContainer()
	{
		...
		container.add(new PluginModulePart("Guiced Servlets - JSF"));
		container.add(buildScreen());
		container.add(buildGoToSource(JSFDisplayPart.class));
		return container;
	}
	...
	private Div buildScreen()
	{
		...
		persistence.add(new JSFDisplayPart(false));
		return persistence;
	}
