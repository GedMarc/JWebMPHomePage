...
public class SubscriberVisitorsBuilder extends QueryBuilderCore<SubscriberVisitorsBuilder, SubscriberVisitors, Long>
{
	...
	{
		Predicate visitorEquals = getCriteriaBuilder().equal(getRoot().get((SingularAttribute) SubscriberVisitors_.visitorID), visitor);
		getFilters().add(visitorEquals);
		return this;
	}
	@Override
