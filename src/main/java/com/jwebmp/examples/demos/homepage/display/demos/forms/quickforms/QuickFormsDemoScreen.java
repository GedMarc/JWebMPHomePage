		...
		extends DemoScreen
{
	...
	{
		add(new DefaultPackageAPI("com.jwebmp.plugins.quickforms", QuickFormsPageConfigurator.class,
		                          "Quick Forms", true, true));
		add(buildGoToSource(QuickFormsPageConfigurator.class, DefaultPackageAPI.class));
