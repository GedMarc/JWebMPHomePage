		...
		extends DisplayPart<JPAModuleScreen>
{
	public JPAModuleScreen()
	{
		...
		all.add("It is recommended to use a DataSource pool, such as C3P0, or similar with JPA Connections. <br/>" +
		        "These can be easily included by referencing the add-on module.");
